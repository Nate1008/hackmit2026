...
For raw video to separate per-object GLB meshes, see [VIDEO_PIPELINE.md](VIDEO_PIPELINE.md).

For the upload UI, ephemeral FastAPI backend, live pipeline previews, and editable
Three.js result viewer, see [FULLSTACK.md](FULLSTACK.md).
